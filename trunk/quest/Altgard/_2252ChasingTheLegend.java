...
public class _2252ChasingTheLegend extends QuestHandler {
	...
	private final static int[] mob_ids = { 210634 };
	...
	public void register() {
		...
		qe.registerQuestNpc(700060).addOnTalkEvent(questId);
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			...
			if (targetId == 700060) { // Bone of Minushan
				switch (dialog) {
					case USE_OBJECT:
						if (var == 0) {
							...
							ThreadPoolManager.getInstance().schedule(new Runnable() {
								...
								public void run() {
									...
									QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 210634, npc.getX(), npc.getY(), npc.getZ(), npc.getHeading());
