...
public class _2019SecuringTheSupplyRoute extends QuestHandler {
			...
			switch (targetId) {
				case 798033: // Neparinerk
					switch (env.getDialog()) {
						...
						case SETPRO2:
							return defaultCloseDialog(env, 4, 5, 182203024, 1, 0, 0);
						default:
							break;
					}
				case 203673: // Banatisai
					switch (env.getDialog()) {
						case QUEST_SELECT:
							if (var == 5) {
	...
	public boolean onKillEvent(QuestEnv env) {
		...
		switch (targetId) {
			case 210492: // Crimsontail Ampha
			case 210493: // Crimsontail Ampha
				if (var >= 1 && var < 4) {
