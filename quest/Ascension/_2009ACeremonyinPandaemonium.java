...
public class _2009ACeremonyInPandaemonium extends QuestHandler {
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (qs.getStatus() == QuestStatus.START) {
			...
			} else if (targetId == 204182) { // Heimdall
				switch (env.getDialog()) {
					case QUEST_SELECT:
						if (var == 1) {
			...
			} else if (targetId == 204075) { // Balder
				switch (env.getDialog()) {
					case QUEST_SELECT:
						if (var == 2) {
			...
			if (targetId == 204080 && var == 10) { // Kalsten
			...
			} else if (targetId == 204081 && var == 20) { // Thialfi
				switch (env.getDialogId()) {
					case -1:
			...
			} else if (targetId == 204082 && var == 30) { // Ve
				switch (env.getDialogId()) {
					case -1:
			...
			} else if (targetId == 204083 && var == 40) { // Lyfjaberga
				switch (env.getDialogId()) {
					case -1:
			...
			} else if (targetId == 801220 && var == 50) { // Mesaina
				switch (env.getDialogId()) {
					case -1:
			...
			} else if (targetId == 801221 && var == 60) { // Godfrey
				switch (env.getDialogId()) {
					case -1:
