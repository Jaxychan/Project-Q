...
public class _30349BetterStringedInstrument extends QuestHandler {

	private final static int questId = 30349;

	public _30349BetterStringedInstrument() {
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			if (targetId == 799336) { // Tataka
				if (player.getInventory().getItemCountByItemId(102000690) >= 1) {
