...
public class _30249NewStringedInstrument extends QuestHandler {

	private final static int questId = 30249;

	public _30249NewStringedInstrument() {
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			if (targetId == 799032) { // Gefeios
				if (player.getInventory().getItemCountByItemId(102000685) >= 1) {
