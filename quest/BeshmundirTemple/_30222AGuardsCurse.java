		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			switch (targetId) {
				case 216739: { // Warrior Monument
					...
					QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 216239, npc.getX(), npc.getY(), npc.getZ(), npc.getHeading());
					return true;
				}
				case 216239: { // Ahbana the Wicked
					return defaultOnKillEvent(env, 216239, 0, 1);
				}
			}
		}
		return false;
