...
public class 1922DeliverOnYourPromises extends QuestHandler {
	...
	public 1922DeliverOnYourPromises() {
		super(questId);
	}
		...
		if (qs.getStatus() == QuestStatus.START) {
			if (qs.getQuestVarById(0) == 5) {
				if (qs.getQuestVarById(4) < 9) {
					return defaultOnKillEvent(env, mob_ids, 0, 9, 4);
				} else if (qs.getQuestVarById(4) == 9) {
					defaultOnKillEvent(env, mob_ids, 9, 10, 4);
